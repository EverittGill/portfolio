...
function Navigation({ currentPage, handlePageChange }) {
  return (
    <nav className="bg-gradient-to-r from-blue-600 to-white py-4">
    {/* // <nav className="animate-bg bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent mr-6"> */}
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-end">
          <a
            href="#about-me"
            onClick={() => handlePageChange('about me')}
            className="text-2xl font-semibold animate-text bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent mr-6"
          >
            About Me
          </a>
          <a
